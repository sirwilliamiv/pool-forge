    ...
    <div className="space-y-6">
            ...
            <div className="mt-4 space-y-2" data-testid="team-result">
              ...
              {result.ok && result.link ? (
                <div className="flex flex-col gap-2 sm:flex-row">
                  <Input readOnly value={result.link} data-testid="invite-link" />
                  <Button
                    type="button"
                    variant="secondary"
                    onClick={() => {
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            {members.length} {members.length === 1 ? 'person' : 'people'} at {orgName}.
          </CardDescription>
        </CardHeader>
          ...
          <table className="w-full text-sm" data-testid="member-table">
            ...
            <tbody>
              {members.map((member) => {
                ...
                return (
                  <tr key={member.userId} className="border-b last:border-0" data-testid="member-row">
      ...
      <Card>
        ...
        {invites.length > 0 ? (
          <CardContent className="overflow-x-auto">
            <table className="w-full text-sm" data-testid="invite-table">
              <thead>
                <tr className="border-b text-left text-xs uppercase tracking-wide text-muted-foreground">
              ...
              <tbody>
                {invites.map((invite) => (
                  <tr key={invite.id} className="border-b last:border-0" data-testid="invite-row">
                    <td className="py-3 pr-4">
                    ...
                    <td className="py-3 pr-4">{ROLE_LABEL[invite.role]}</td>
                    <td className="py-3 pr-4 text-muted-foreground">{invite.expiresAt}</td>
                    <td className="py-3 pr-4 text-right">
                      <Button
                        type="button"
                        variant="ghost"
