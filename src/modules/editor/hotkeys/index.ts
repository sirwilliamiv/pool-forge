...
export const HOTKEYS: Hotkey[] = [
  ...
  { shortcut: 'p', commandId: 'tool.activate', description: 'Line tool', input: { tool: 'line' } },
  { shortcut: 'a', commandId: 'tool.activate', description: 'Curve tool', input: { tool: 'curve' } },
  { shortcut: 'n', commandId: 'tool.activate', description: 'Freehand tool', input: { tool: 'freehand' } },
