# 40. Pools By Mike Inc

| | |
|---|---|
| Volume | 23 permits / 24 mo (rank #40 of 440) |
| Footprint | Tampa:20; Hillsborough County (unincorporated):3 |
| License | CPC1459395 |
| Phone | (813)672-0061 |
| Email | alafia1@aol.com |
| Mail | 7234 ALAFIA RIDGE LOOP, RIVERVIEW, FL, 33569 |
| Source permit | HC-BLD-26-0083480 |

Status: [ ] not contacted   [ ] emailed   [ ] called   [ ] demo booked   [ ] beta   [ ] pass

## Email 1 (day 0)

Subject: 23 permits, 1 county, one price book?

Hi,

Public permit records show Pools By Mike Inc pulled 23 residential pool permits across Hillsborough in the last 24 months. That's 23 pools in two years, which usually means several designers quoting at once.
...
Subject: Re: 23 permits, one price book?

Hi,

Quick follow-up. The reason I reached out to Pools By Mike Inc specifically: of the 440 companies that pulled a pool permit in Tampa Bay in the last two years, you're #40 by volume. High-volume shops are the ones where quoting speed and price consistency actually move margin.
...
Last note from me. The founding beta is capped at ten builders and I'm filling it from the top of the Tampa Bay volume list, so I wanted to give Pools By Mike Inc the first look before I move down the list.
...
Opener: "Hi, this is Billy, I build software for pool builders here in Tampa. Do you have 60 seconds? ... I was going through county permit records and Pools By Mike Inc came up with 23 residential pool permits across Hillsborough in the last 24 months. Who does the design and quoting when a lead comes in, you or a design team?"
...
- "Too busy" -> "That's the point. You quoted 23 pools in two years; I save time on every one. 15 minutes."
