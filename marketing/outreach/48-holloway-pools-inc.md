# 48. Holloway Pools, Inc

| | |
|---|---|
| Volume | 18 permits / 24 mo (rank #48 of 440) |
| Footprint | Tampa:16; Hillsborough County (unincorporated):2 |
| License | CPC037062 |
| Phone | (813)926-8234 |
| Email | jholloway1@verizon.net |
| Mail | 38233, 1805 GUNN HWY |
| Source permit | HC-BLD-25-0067390 |

Status: [ ] not contacted   [ ] emailed   [ ] called   [ ] demo booked   [ ] beta   [ ] pass

## Email 1 (day 0)

Subject: 18 permits, 1 county, one price book?

Hi,

Public permit records show Holloway Pools, Inc pulled 18 residential pool permits across Hillsborough in the last 24 months. That's 18 pools in two years, which usually means several designers quoting at once.
...
Quick follow-up. The reason I reached out to Holloway Pools, Inc specifically: of the 440 companies that pulled a pool permit in Tampa Bay in the last two years, you're #48 by volume. High-volume shops are the ones where quoting speed and price consistency actually move margin.
...
Last note from me. The founding beta is capped at ten builders and I'm filling it from the top of the Tampa Bay volume list, so I wanted to give Holloway Pools, Inc the first look before I move down the list.
...
Opener: "Hi, this is Billy, I build software for pool builders here in Tampa. Do you have 60 seconds? ... I was going through county permit records and Holloway Pools, Inc came up with 18 residential pool permits across Hillsborough in the last 24 months. Who does the design and quoting when a lead comes in, you or a design team?"
