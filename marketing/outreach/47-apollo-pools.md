...
| | |
|---|---|
| Volume | 18 permits / 24 mo (rank #47 of 440) |
| Footprint | Hillsborough County (unincorporated):17; Tampa:1 |
| License | CPC1457589 |
| Phone | (813)689-5197 / (813)468-7665 |
| Email | hotpool@verizon.net |
| Mail | 38234, PO BOX 6025 |
| Source permit | HC-BLD-26-0085755 |
...
Public permit records show Apollo Pools pulled 18 residential pool permits across Hillsborough in the last 24 months. That's 18 pools in two years, which usually means several designers quoting at once.
...
Quick follow-up. The reason I reached out to Apollo Pools specifically: of the 440 companies that pulled a pool permit in Tampa Bay in the last two years, you're #47 by volume. High-volume shops are the ones where quoting speed and price consistency actually move margin.
...
Last note from me. The founding beta is capped at ten builders and I'm filling it from the top of the Tampa Bay volume list, so I wanted to give Apollo Pools the first look before I move down the list.
...
Opener: "Hi, this is Billy, I build software for pool builders here in Tampa. Do you have 60 seconds? ... I was going through county permit records and Apollo Pools came up with 18 residential pool permits across Hillsborough in the last 24 months. Who does the design and quoting when a lead comes in, you or a design team?"
